...
| VAC-001 | Offline VACUUM preserves logical records, protectors, generation continuity, verification, and old-or-new publication on admitted platforms | ADR-0009; vacuum failure matrix and rebuild tests | Platform-limited | Unix publication is admitted but native Unix CI confirmation remains open; Windows refuses before mutation |
