# Tosumu Error Design Document

| Field | Value |
| --- | --- |
| Authority | Normative public error contract |
| Lifecycle | Current, pre-stability |
| Scope | Stable error identity, status categories, context, and boundary translation |
...
It complements the [Tosumu Software Design Document](Tosumu%20Software%20Design%20Document.md) and [Tosumu Inspect API Specification](Tosumu%20Inspect%20API%20Specification.md). The software design document remains the broader architectural source of truth; this file is the durable reference for how failures should be identified, categorized, propagated, and translated at system boundaries.
...
The current [Tosumu Inspect API Specification](Tosumu%20Inspect%20API%20Specification.md) should stay on one baseline shape with the structured fields that already carry the meaning.
...
INSPECT_PAGE_OUT_OF_RANGE
FILE_OPEN_BUSY
VACUUM_PLATFORM_UNSUPPORTED
VACUUM_DURABILITY_UNCERTAIN
