...
pub const OVERFLOW_CHAIN_CORRUPT: &str = "OVERFLOW_CHAIN_CORRUPT";
...
pub const VACUUM_PLATFORM_UNSUPPORTED: &str = "VACUUM_PLATFORM_UNSUPPORTED";
pub const VACUUM_DURABILITY_UNCERTAIN: &str = "VACUUM_DURABILITY_UNCERTAIN";
pub const SNAPSHOT_LIMIT_REACHED: &str = "SNAPSHOT_LIMIT_REACHED";
pub const TRANSACTION_WAL_TOO_LARGE: &str = "TRANSACTION_WAL_TOO_LARGE";
pub const WAL_RETENTION_LIMIT_REACHED: &str = "WAL_RETENTION_LIMIT_REACHED";
