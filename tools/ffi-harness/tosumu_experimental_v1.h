...
tosumu_experimental_v1_outcome tosumu_experimental_v1_test_inject_unassociated_panic(void);
tosumu_experimental_v1_outcome tosumu_experimental_v1_test_inject_database_panic(uint64_t);
tosumu_experimental_v1_outcome tosumu_experimental_v1_test_inject_database_panic_after_write_acquisition(uint64_t);
tosumu_experimental_v1_outcome tosumu_experimental_v1_test_batch_append_failure(uint64_t, uint32_t);
#endif
